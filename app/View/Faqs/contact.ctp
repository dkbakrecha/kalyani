            ...
            <div class="post clearfix" id="post-383">
                ...
                <div class="col-md-8">
                    <form action="" method="post" class="smart-green">
                        ...
                        <label>
                            <span>Your Name :</span>
                            <?php echo $this->Form->input('name',array('div'=>false,'label'=>false,'placeholder'=>'Your Full Name'));?>
                           
                        </label>

                        <label>
                            <span>Your Email :</span>
                            <?php echo $this->Form->input('email',array('div'=>false,'label'=>false,'placeholder'=>'Valid email address'));?>
                        </label>
                        <label>
                            <span>Contact Number :</span>
                            <?php echo $this->Form->input('mobile',array('div'=>false,'label'=>false,'placeholder'=>'valid mobile number'));?>

                        </label>

                        <label>
                            <span>Message :</span>
                             <?php echo $this->Form->input('message',array('div'=>false,'label'=>false,'placeholder'=>'Your Message','rows'=>25,'cols'=>'25'));?>
                        </label> 
                        <label>
                            <span>Captecha : </span>
                            <?php echo $this->Form->input('captecha',array('div'=>false,'type'=>'text','label'=>false,'placeholder'=>'How Much'));?>
                        </label>    
                        <label>
                            <span>&nbsp;</span> 
