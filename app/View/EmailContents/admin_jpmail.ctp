			...
			<div id="box_bg" class="row-fluid" style="display:block;">
				<div id="content_admin" class="admin_content_block">
					...
					echo $this->Form->submit("SEND", array(
						...
						'div'=>false,
						'onclick'=>'return validate("content")'
						)
					);
					?>
...
$(function(){
	<?php /*?>$( 'textarea#EmailContentContent' ).ckeditor( {filebrowserUploadUrl:"<?php echo $this->Html->url(array('action'=>'ckupload')) ?>"} );<?php */?>
	
	tinymce.init({ selector: "textarea#EmailContentContent",  plugins: "image" });
